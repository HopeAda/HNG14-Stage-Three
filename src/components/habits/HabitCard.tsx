...
export default function HabitCard({ habit }: CardProviderProps) {
	...
	return (
		<article
			className="flex flex-col justify-between w-full bg-[#f8f8f8]  shadow-md p-4! rounded-md gap-4"
		...
		>
			<div className="flex gap-2 items-start">
				...
				<div className="flex flex-col gap-1.25 w-full">
					<p
						className="text-md leading-none font-semibold cursor-pointer w-full capitalize whitespace-pre-wrap break-all hyphens-auto"
						id={`${cardSlug}-id`}
			...
			<div className="flex flex-col w-full gap-1">
				<div className="text-[12px] flex gap-1 items-center   w-fit font-medium px-2! py-1! bg-gray-200 rounded-xl leading-none">
